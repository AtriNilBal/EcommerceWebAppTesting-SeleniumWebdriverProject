...
public class UserLoginLogoutJourneyTestNgTestsOnFirefox {
    ...
    private static final Logger LOGGER = LogManager.getLogger(UserLoginLogoutJourneyTestNgTestsOnFirefox.class.getName());
